export function calculatePrice({ basePrice, condition, screenCondition, functionalIssues = [], accessories, conditionMultipliers, screenMultipliers, functionalDeductions, accessoriesBonus }) {
  ...
  const raw = (basePrice * condMult * screenMult) - funcDeduction + accBonus;
